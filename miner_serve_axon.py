...
async def boot():
    ...
    parser.add_argument('--subtensor_address', type=str, default="ws://144.126.145.166:9944")
    parser.add_argument('--wallet_path', type=str, default="~/.bittensor/wallets/")

    args = parser.parse_args()

    if args.external_ip is None:
        args.external_ip = "0.0.0.0" if args.dev_flag else get_external_ip()
